package org.mcadminToolkit.express.utils.middleware;

import org.mcadminToolkit.express.utils.middleware.CookieSession;
...
public final class Middleware {
     ...
     */
    public static org.mcadminToolkit.express.utils.middleware.CookieSession cookieSession(String cookieName, long maxAge) {
        return new org.mcadminToolkit.express.utils.middleware.CookieSession(cookieName, maxAge);
    }
    ...
    public static FileProvider statics(String directoryPath) throws IOException {
        return new FileProvider(directoryPath, new org.mcadminToolkit.express.utils.middleware.FileProviderOptions());
    }
